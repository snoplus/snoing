...
class SnogogglesDev( Snogoggles.Snogoggles ):
    ...
    def __init__( self ):
        ...
        super( SnogogglesDev, self ).__init__( "snogoggles-dev", "scons-2.1.0", "geant4.9.5.p01", "clhep-2.1.1.0", "rat-dev", "root-5.32.04", "sfml-2.0-rc", "xerces-c-3.1.1", "avalanche-1", "zeromq-2.2.0", "curl-7.26.0", "bzip2-1.0.6" )
        return
...
class SnogogglesAirFill( Snogoggles.SnogogglesRelease ):
    ...
    def __init__( self ):
        super( SnogogglesAirFill, self ).__init__( "snogoggles-airfill", "604ae90e913586360779f96035bbab6c4709964f", "scons-2.1.0", "geant4.9.4.p01", "clhep-2.1.0.1", "rat-3", "root-5.32.04", "sfml-1.8", "xerces-c-3.1.1", "avalanche-1", "zeromq-2.2.0", "curl-7.26.0", "bzip2-1.0.6" )
        return
