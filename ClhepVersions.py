...
class CLHEP2101( Clhep.Clhep ):
    ...
    def __init__( self, cachePath, installPath ):
        ...
        super( CLHEP2101, self ).__init__( "clhep-2.1.01", cachePath, installPath, "clhep-2.1.0.1.tgz" )
        return
    def _Download( self ):
...
class CLHEP2042( Clhep.Clhep ):
    ...
    def __init__( self, cachePath, installPath ):
        ...
        super( CLHEP52400, self ).__init__( "clhep-2.0.4.2", cachePath, installPath, "clhep-2.0.4.2.tgz" )
        return
    def _Download( self ):
        """ Derived classes should override this to download the package. Return True on success."""
