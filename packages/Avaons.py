...
class Avaons( LocalPackage.LocalPackage ):
    ...
    def __init__( self, name, zmqDependency, curlDependency, rootDependency, ratDependency, bzipDependency, avalancheDependency ):
    ...
    def GetDependencies( self ):
        ...
        return ["python-dev", self._ZeromqDependency, self._CurlDependency, self._RootDependency, self._RatDependency, self._BZipDependency, self._AvalancheDepdency]
    ...
    def _Install( self ):
        ...
        envFile.AddEnvironment( "G4SYSTEM", os.uname()[0] )
        ...
        envFile.AddEnvironment( "AVALANCHEROOT", self._DependencyPaths[self._AvalanceDependency] )
