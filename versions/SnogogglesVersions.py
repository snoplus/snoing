...
class SnogogglesDev( Snogoggles.Snogoggles ):
    ...
    def __init__( self ):
        ...
        super( SnogogglesDev, self ).__init__( "snogoggles-dev", "scons-2.1.0", "geant4.9.4.p01", "rat-dev", "root-5.32.03", "sfml-1.8", "xerces-c-3.1.1", "avalanche-1", "zeromq-2.2.0", "curl-7.26.0", "bzip2-1.0.6" )
        return
