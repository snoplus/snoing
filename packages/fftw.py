...
class Fftw(conditionallibrarypackage.ConditionalLibraryPackage):
    ...
    def _is_installed(self):
        ...
        header = self._system.file_exists("fftw.h", os.path.join(self.get_install_path(), 
                                                                 "include/fftw"))
        lib = self._system.library_exists("libfftw", os.path.join(self.get_install_path(), "lib"))
