...
class RAT6169(ratreleases.RatRelease6):
    """Rat release-6.16.9, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.16.9 package."""
        super(RAT6169, self).__init__('rat-6.16.9', system, 'root-5.34.36', '6.16.9')


class RAT6168(ratreleases.RatRelease6):
    """Rat release-6.16.8, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.16.8 package."""
        super(RAT6168, self).__init__('rat-6.16.8', system, 'root-5.34.36', '6.16.8')


class RAT6167(ratreleases.RatRelease6):
    """Rat release-6.16.7, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.16.7 package."""
        super(RAT6167, self).__init__('rat-6.16.7', system, 'root-5.34.36', '6.16.7')


class RAT6166(ratreleases.RatRelease6):
    """Rat release-6.16.6, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.16.6 package."""
        super(RAT6166, self).__init__('rat-6.16.6', system, 'root-5.34.36', '6.16.6')


class RAT6165(ratreleases.RatRelease6):
    """Rat release-6.16.5, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.16.5 package."""
        super(RAT6165, self).__init__('rat-6.16.5', system, 'root-5.34.36', '6.16.5')


class RAT6164(ratreleases.RatRelease6):
    """Rat release-6.16.4, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.16.4 package."""
        super(RAT6164, self).__init__('rat-6.16.4', system, 'root-5.34.36', '6.16.4')


class RAT6163(ratreleases.RatRelease6):
    """Rat release-6.16.3, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.16.3 package."""
        super(RAT6163, self).__init__('rat-6.16.3', system, 'root-5.34.36', '6.16.3')


class RAT6162(ratreleases.RatRelease6):
    """Rat release-6.16.2, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.16.2 package."""
        super(RAT6162, self).__init__('rat-6.16.2', system, 'root-5.34.36', '6.16.2')


class RAT6161(ratreleases.RatRelease6):
    """Rat release-6.16.1, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.16.1 package."""
        super(RAT6161, self).__init__('rat-6.16.1', system, 'root-5.34.36', '6.16.1')


class RAT6160(ratreleases.RatRelease6):
    """Rat release-6.16.0, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.16.0 package."""
        super(RAT6160, self).__init__('rat-6.16.0', system, 'root-5.34.36', '6.16.0')


class RAT6153(ratreleases.RatRelease6):
    """Rat release-6.15.3, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.15.3 package."""
        super(RAT6153, self).__init__('rat-6.15.3', system, 'root-5.34.36', '6.15.3')


class RAT6152(ratreleases.RatRelease6):
...
class RAT6151(ratreleases.RatRelease6):
    """Rat release-6.15.1, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.15.1 package."""
        super(RAT6151, self).__init__('rat-6.15.1', system, 'root-5.34.36', '6.15.1')


class RAT6150(ratreleases.RatRelease6):
    """Rat release-6.15.0, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.15.0 package."""
        super(RAT6150, self).__init__('rat-6.15.0', system, 'root-5.34.36', '6.15.0')
...
class RAT658(ratreleases.RatRelease6):
    """Rat release-6.5.8, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.5.8 package."""
        super(RAT658, self).__init__('rat-6.5.8', system, 'root-5.34.36', '6.5.8')


class RAT657(ratreleases.RatRelease6):
    """Rat release-6.5.7, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.5.7 package."""
        super(RAT657, self).__init__('rat-6.5.7', system, 'root-5.34.36', '6.5.7')


class RAT656(ratreleases.RatRelease6):
    """Rat release-6.5.6, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.5.6 package."""
        super(RAT656, self).__init__('rat-6.5.6', system, 'root-5.34.36', '6.5.6')


class RAT655(ratreleases.RatRelease6):
    """Rat release-6.5.5, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.5.5 package."""
        super(RAT655, self).__init__('rat-6.5.5', system, 'root-5.34.36', '6.5.5')


class RAT654(ratreleases.RatRelease6):
    """Rat release-6.5.4, install package."""
    def __init__(self, system):
        """Initiliase the rat 6.5.4 package."""
        super(RAT654, self).__init__('rat-6.5.4', system, 'root-5.34.36', '6.5.4')
