...
class RAT4(ratreleases.RatRelease4):
    ...
    def __init__(self, system):
        ...
        super(RAT4, self).__init__("rat-4", system, "root-5.32.04", "geant4.9.5.p01", "scons-2.1.0", 
...
class RAT3(ratreleases.RatRelease3):
    ...
    def __init__(self, system):
        ...
        super(RAT3, self).__init__("rat-3", system, "root-5.32.04", "geant4.9.4.p01", "scons-2.1.0", 
...
class RAT2(ratreleases.RatRelease2):
    ...
    def __init__(self, system):
        ...
        super(RAT2, self).__init__("rat-2", system, "root-5.28.00", "geant4.9.4.p01", "scons-2.1.0", 
...
class RAT1(ratreleases.RatRelease0and1):
    ...
    def __init__(self, system):
        ...
        super(RAT1, self).__init__("rat-1", system, "root-5.24.00", "geant4.9.2.p02", "scons-1.2.0", 
...
class RAT0(ratreleases.RatRelease0and1):
    ...
    def __init__(self, system):
        ...
        super(RAT0, self).__init__("rat-0", system, "root-5.24.00", "geant4.9.2.p02", "scons-1.2.0", 
